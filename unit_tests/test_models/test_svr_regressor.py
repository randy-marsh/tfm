...
class TestSVRRegressorProperties(unittest.TestCase):

    def setUp(self) -> None:
        self.model = src.models.svr_regressor.SVRRegressor(X=numpy.array([[1, 2, 3], [4, 5, 6]]),
    ...
    def test_that_estimator_name_can_be_read(self):
        self.assertEqual(self.model.estimator_name, 'SVR Regression')