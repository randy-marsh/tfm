...
class TestRidgeRegressorProperties(unittest.TestCase):

    def setUp(self) -> None:
        self.model = src.models.ridge_regressor.RidgeRegressor(X=numpy.array([[1, 2, 3], [4, 5, 6]]),
    ...
    def test_that_estimator_name_can_be_read(self):
        self.assertEqual(self.model.estimator_name, 'Ridge Regression')